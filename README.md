...
|**US-27**|Recuperación de contraseña|<p>Como usuario registrado quiero recuperar mi contraseña para poder acceder nuevamente a la plataforma en caso de olvido.</p>|<p>**Escenario 1: Solicitud de recuperación**</p><p>**Given** el usuario se encuentra en la pantalla de login,</p><p>**When** hace clic en "Olvidé mi contraseña",</p><p>**Then** el sistema solicita su correo electrónico</p><p>**And** envía un enlace de recuperación.</p>|**EP01**|
|**US-28**|Cierre de sesión seguro|<p>Como usuario quiero cerrar sesión para proteger mi información personal.</p>|<p>**Escenario 1: Cierre exitoso**</p><p>**Given** el usuario está autenticado,</p><p>**When** presiona el botón "Cerrar sesión",</p><p>**Then** el sistema finaliza la sesión activa</p><p>**And** redirige a la pantalla de login.</p>|**EP01**|
|**US-29**|Visualización de perfil|<p>Como usuario quiero visualizar mi información personal para verificar mis datos registrados.</p>|<p>**Escenario 1: Visualización de datos**</p><p>**Given** el usuario accede a su perfil,</p><p>**When** la sección carga correctamente,</p><p>**Then** el sistema muestra su información personal almacenada.</p>|**EP01**|
|**US-30**|Desvinculación de wearable|<p>Como usuario quiero desvincular mi dispositivo wearable para poder conectar uno nuevo.</p>|<p>**Escenario 1: Desvinculación exitosa**</p><p>**Given** existe un dispositivo vinculado,</p><p>**When** el usuario selecciona "Desvincular",</p><p>**Then** el sistema elimina la conexión activa.</p>|**EP02**|
|**US-31**|Estado del dispositivo|<p>Como usuario quiero visualizar el estado de conexión de mi wearable para asegurar el monitoreo.</p>|<p>**Escenario 1: Estado visible**</p><p>**Given** el usuario accede a configuración,</p><p>**When** visualiza el apartado de dispositivos,</p><p>**Then** el sistema muestra el estado "Conectado" o "Desconectado".</p>|**EP02**|
|**US-32**|Sincronización automática de datos|<p>Como usuario quiero que mis datos biométricos se sincronicen automáticamente para no perder información.</p>|<p>**Escenario 1: Sincronización en segundo plano**</p><p>**Given** el dispositivo está conectado,</p><p>**When** se generan datos biométricos,</p><p>**Then** el sistema sincroniza la información automáticamente.</p>|**EP02**|
|**US-33**|Silenciar alertas temporalmente|<p>Como usuario quiero silenciar alertas para evitar interrupciones durante procedimientos críticos.</p>|<p>**Escenario 1: Activación de modo silencio**</p><p>**Given** el usuario recibe alertas,</p><p>**When** activa el modo silencio,</p><p>**Then** el sistema pausa las notificaciones temporalmente.</p>|**EP03**|
|**US-34**|Historial de alertas|<p>Como usuario quiero revisar las alertas pasadas para analizar mi comportamiento.</p>|<p>**Escenario 1: Consulta de historial**</p><p>**Given** existen alertas registradas,</p><p>**When** el usuario accede al historial,</p><p>**Then** el sistema muestra todas las alertas previas.</p>|**EP03**|
|**US-35**|Escalamiento automático de alertas|<p>Como sistema quiero escalar alertas críticas para prevenir riesgos mayores.</p>|<p>**Escenario 1: Escalamiento**</p><p>**Given** el usuario ignora una alerta,</p><p>**When** pasa el tiempo límite,</p><p>**Then** el sistema notifica a un supervisor.</p>|**EP03**|
|**US-36**|Filtrado de médicos por estado|<p>Como administrador quiero filtrar médicos según su nivel de estrés para priorizar atención.</p>|<p>**Escenario 1: Aplicación de filtros**</p><p>**Given** existen datos de médicos,</p><p>**When** aplica un filtro,</p><p>**Then** el sistema muestra resultados filtrados.</p>|**EP04**|
|**US-37**|Visualización de estadísticas globales|<p>Como administrador quiero ver métricas globales para tomar decisiones estratégicas.</p>|<p>**Escenario 1: Visualización de dashboard**</p><p>**Given** el administrador accede al panel,</p><p>**When** carga la vista,</p><p>**Then** el sistema muestra gráficos y métricas.</p>|**EP04**|
|**US-38**|Envío de notificaciones masivas|<p>Como administrador quiero enviar alertas generales para prevenir riesgos colectivos.</p>|<p>**Escenario 1: Notificación enviada**</p><p>**Given** existe un riesgo detectado,</p><p>**When** el administrador envía el mensaje,</p><p>**Then** todos los usuarios reciben la notificación.</p>|**EP04**|
|**US-39**|Visualización de demo del producto|<p>Como visitante quiero ver una demostración del sistema para entender su funcionamiento.</p>|<p>**Escenario 1: Reproducción de video**</p><p>**Given** el usuario accede a la landing,</p><p>**When** reproduce el video,</p><p>**Then** visualiza la demo del sistema.</p>|**EP05**|
|**US-40**|Descarga de brochure informativo|<p>Como visitante quiero descargar información del producto para evaluarlo.</p>|<p>**Escenario 1: Descarga exitosa**</p><p>**Given** el usuario accede a la sección,</p><p>**When** hace clic en descargar,</p><p>**Then** obtiene el archivo PDF.</p>|**EP05**|
|**US-41**|Registro de interés comercial|<p>Como visitante quiero dejar mis datos para ser contactado por el equipo comercial.</p>|<p>**Escenario 1: Registro exitoso**</p><p>**Given** el usuario completa el formulario,</p><p>**When** lo envía,</p><p>**Then** el sistema guarda la información.</p>|**EP05**|
|**US-42**|Ajuste automático de IA|<p>Como sistema quiero ajustar parámetros según comportamiento del usuario.</p>|<p>**Escenario 1: Ajuste automático**</p><p>**Given** existen datos históricos,</p><p>**When** se analizan,</p><p>**Then** el sistema mejora la precisión.</p>|**EP06**|
|**US-43**|Reentrenamiento del modelo|<p>Como sistema quiero mejorar continuamente el modelo predictivo.</p>|<p>**Escenario 1: Reentrenamiento**</p><p>**Given** nuevos datos disponibles,</p><p>**When** se procesan,</p><p>**Then** el sistema mejora su rendimiento.</p>|**EP06**|
|**US-44**|Feedback negativo del usuario|<p>Como usuario quiero reportar errores en alertas para mejorar el sistema.</p>|<p>**Escenario 1: Registro de feedback**</p><p>**Given** una alerta incorrecta,</p><p>**When** el usuario reporta,</p><p>**Then** el sistema registra el feedback.</p>|**EP06**|
|**US-45**|Guardar técnicas favoritas|<p>Como usuario quiero guardar ejercicios favoritos para acceder rápidamente.</p>|<p>**Escenario 1: Guardado exitoso**</p><p>**Given** el usuario selecciona una técnica,</p><p>**When** la guarda,</p><p>**Then** aparece en favoritos.</p>|**EP07**|
|**US-46**|Recomendación personalizada|<p>Como sistema quiero recomendar técnicas según el nivel de estrés.</p>|<p>**Escenario 1: Recomendación activa**</p><p>**Given** se detecta estrés alto,</p><p>**When** analiza datos,</p><p>**Then** sugiere ejercicios adecuados.</p>|**EP07**|
|**US-47**|Seguimiento de progreso|<p>Como usuario quiero visualizar mi progreso para mejorar mi bienestar.</p>|<p>**Escenario 1: Visualización de progreso**</p><p>**Given** existen datos históricos,</p><p>**When** accede a métricas,</p><p>**Then** el sistema muestra evolución.</p>|**EP07**|
|**US-48**|Protección de datos sensibles|<p>Como sistema quiero asegurar la privacidad de los datos médicos.</p>|<p>**Escenario 1: Encriptación**</p><p>**Given** se almacenan datos,</p><p>**When** se guardan,</p><p>**Then** se encriptan correctamente.</p>|**EP01**|
|**US-49**|Control de acceso por roles|<p>Como sistema quiero restringir accesos según roles para mayor seguridad.</p>|<p>**Escenario 1: Acceso restringido**</p><p>**Given** un usuario sin permisos,</p><p>**When** intenta acceder,</p><p>**Then** el sistema bloquea el acceso.</p>|**EP04**|
|**US-50**|Registro de actividad del sistema|<p>Como sistema quiero registrar todas las acciones para auditoría.</p>|<p>**Escenario 1: Registro de logs**</p><p>**Given** el usuario interactúa,</p><p>**When** realiza acciones,</p><p>**Then** el sistema guarda un registro.</p>|**EP04**|
